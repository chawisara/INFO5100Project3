...
function liquidFillGaugeDefaultSettings(){
    return {
        ...
        circleColor: "#A6BF50", // The color of the outer circle.
        ...
        waveColor: "#A6BF50", // The color of the fill wave.
        ...
        textColor: "#485B06", // The color of the value text when the wave does not overlap it.
        waveTextColor: "#F5FFD2" // The color of the value text when the wave overlaps it.
    };
}
